...
# ACDS 21.1 842 linux 2025.04.30.14:01:10
# ----------------------------------------
...
# ----------------------------------------
# If InvSqrt is one of several IP cores in your
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/InvSqrt_memoryC5_uid80_invSqrtTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/InvSqrt_memoryC4_uid77_invSqrtTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/InvSqrt_memoryC4_uid76_invSqrtTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/InvSqrt_memoryC3_uid73_invSqrtTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/InvSqrt_memoryC3_uid72_invSqrtTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/InvSqrt_memoryC2_uid69_invSqrtTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/InvSqrt_memoryC2_uid68_invSqrtTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/InvSqrt_memoryC1_uid65_invSqrtTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/InvSqrt_memoryC1_uid64_invSqrtTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/InvSqrt_memoryC1_uid63_invSqrtTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/InvSqrt_memoryC0_uid60_invSqrtTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/InvSqrt_memoryC0_uid59_invSqrtTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/InvSqrt_memoryC0_uid58_invSqrtTables_lutmem.hex ./
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/InvSqrt.vo"
}
