...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/Invert_memoryC5_uid91_inverseTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/Invert_memoryC4_uid88_inverseTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/Invert_memoryC3_uid85_inverseTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/Invert_memoryC2_uid82_inverseTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/Invert_memoryC2_uid81_inverseTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/Invert_memoryC1_uid78_inverseTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/Invert_memoryC1_uid77_inverseTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/Invert_memoryC0_uid74_inverseTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/Invert_memoryC0_uid73_inverseTables_lutmem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/Invert.vo"
fi
