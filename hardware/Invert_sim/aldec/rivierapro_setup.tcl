...
# ACDS 21.1 842 linux 2025.04.22.16:38:54
# ----------------------------------------
...
# ----------------------------------------
# If Invert is one of several IP cores in your
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/Invert_memoryC5_uid91_inverseTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/Invert_memoryC4_uid88_inverseTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/Invert_memoryC3_uid85_inverseTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/Invert_memoryC2_uid82_inverseTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/Invert_memoryC2_uid81_inverseTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/Invert_memoryC1_uid78_inverseTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/Invert_memoryC1_uid77_inverseTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/Invert_memoryC0_uid74_inverseTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/Invert_memoryC0_uid73_inverseTables_lutmem.hex ./
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/Invert.vo"
}
