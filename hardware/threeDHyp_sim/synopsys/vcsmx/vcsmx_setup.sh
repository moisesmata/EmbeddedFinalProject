...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/threeDHyp_memoryC5_uid210_sqrtTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/threeDHyp_memoryC4_uid207_sqrtTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/threeDHyp_memoryC3_uid204_sqrtTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/threeDHyp_memoryC2_uid201_sqrtTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/threeDHyp_memoryC1_uid198_sqrtTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/threeDHyp_memoryC1_uid197_sqrtTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/threeDHyp_memoryC0_uid194_sqrtTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/threeDHyp_memoryC0_uid193_sqrtTables_lutmem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/threeDHyp.vo"
fi
