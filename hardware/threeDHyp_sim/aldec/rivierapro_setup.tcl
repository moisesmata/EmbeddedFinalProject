...
# ACDS 21.1 842 linux 2025.04.22.16:35:10
# ----------------------------------------
...
# ----------------------------------------
# If threeDHyp is one of several IP cores in your
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/threeDHyp_memoryC5_uid210_sqrtTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/threeDHyp_memoryC4_uid207_sqrtTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/threeDHyp_memoryC3_uid204_sqrtTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/threeDHyp_memoryC2_uid201_sqrtTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/threeDHyp_memoryC1_uid198_sqrtTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/threeDHyp_memoryC1_uid197_sqrtTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/threeDHyp_memoryC0_uid194_sqrtTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/threeDHyp_memoryC0_uid193_sqrtTables_lutmem.hex ./
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/threeDHyp.vo"
}
